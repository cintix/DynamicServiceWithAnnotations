/*
 */
package dynamicservice.io.xml;

import dynamicservice.io.xml.annotations.Alias;
import dynamicservice.io.xml.annotations.Items;
...
public class XmlMapper {
    ...
    private static SimpleDateFormat simpleDateFormater = new SimpleDateFormat(simpleDateFormat);
    ...
    private static String writeDate(Object o, String name, int indent) {
        ...
        Date date = (Date) o;
        if (o != null) {
            stringBuilder.append(simpleDateFormater.format(o));
        }
        stringBuilder.append("</").append(name).append(">\n");
        return stringBuilder.toString();
    }
